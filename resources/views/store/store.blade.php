                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ route('orders') }}"><i class="fa fa-lock"></i> Acesso restrito</a></li>
                            @if (Auth::guest())
                                <li><a href="/auth/login"><i class="fa fa-lock"></i> Login</a></li>
                            @else
                                <li><a href="/auth/logout"><i class="fa fa-lock"></i> {{Auth::user()->name}}(Sair)</a></li>
